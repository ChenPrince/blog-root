...
public class PersonalController {
    ...
    @ApiOperation(value="article id",notes="文章 id",produces = MediaType.APPLICATION_PROBLEM_JSON_UTF8_VALUE)
    @RequestMapping(value="/deleteArticleByArticleId",method=RequestMethod.GET)
    public JSONResult deleteArticleByArticleId(@Valid DeleteArticleByArticleIdInputDTO input){
